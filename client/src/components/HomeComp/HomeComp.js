      ...
      <div className="why-container">
        ...
        <div className="get-your-container">
          ...
          <div className="get-quote-btn-container">
            ...
            {location.pathname.split('/')[1] === 'dsp-prop-pop' ? <p className='get-quote-num'>Call <a style={{ textDecoration: 'none', fontSize: '20px', color: 'white' }} href='tel:18447992424'>1(844)799-2424</a> To Speak With Our Licensed Insurance Agents For Quick Assistance</p> :
              location.pathname.split('/')[1] === 'goog' ? <p className='get-quote-num'>Call <a style={{ textDecoration: 'none', fontSize: '20px', color: 'white' }} href='tel:18777110738'>1(877)711-0738</a> To Speak With Our Licensed Insurance Agents For Quick Assistance</p> :
                location.pathname.split('/')[1] === 'dsp' ? <p className='get-quote-num'>Call <a style={{ textDecoration: 'none', fontSize: '20px', color: 'white' }} href='tel:18664140150'>1(866)414-0150</a> To Speak With Our Licensed Insurance Agents For Quick Assistance</p> :
                  location.pathname.split('/')[1] === 'fb' ? <p className='get-quote-num'>Call <a style={{ textDecoration: 'none', fontSize: '20px', color: 'white' }} href='tel:18775573335'>1(877)557-3335</a> To Speak With Our Licensed Insurance Agents For Quick Assistance</p> :
                    <p className='get-quote-num'>Call <a style={{ textDecoration: 'none', fontSize: '20px', color: 'white' }} href='tel:8884312082'>(888) 431-2082</a> To Speak With Our Licensed Insurance Agents For Quick Assistance</p>}
          </div>
        </div>
      </div>
      <Footer />
